    ...
    <main className='register'>
      <Row >
        ...
        <Col xs={24} md={12} lg={12} xl={11} className="d-flex  justify-content-center flex-column  px-5" >
          ...
          <p className='text-muted'>Kindly Enter Your Details</p>
          ...
          <Form layout={"vertical"} className='mt-2' onSubmitCapture={handleSubmit}>
            ...
            <Button type='primary' htmlType='submit' size='large' loading={isProcessing} block className='mt-3'>Register</Button>
            <Link className='text-decoration-none' to="/auth/Login">Already a USER?</Link>

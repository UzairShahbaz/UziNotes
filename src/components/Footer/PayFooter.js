  ...
  return (
    ...
    <hr />
        <div className="row d-flex justify-content-between mb-5  ">
          ...
          <div className="col col-12 col-sm-12 col-md-5 col-lg-6 col-xl-5 text-lg-center  ">
            <Paragraph className='text-white'>&copy;{year} UziNotes.AllRight Reserved</Paragraph>
          </div>
